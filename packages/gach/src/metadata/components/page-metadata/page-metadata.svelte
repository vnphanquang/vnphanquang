<script lang="ts">
	import { buildStructuredBreadcrumbs, toStringWithContext } from '../../structured';
	import { getPageMetadataDefaults } from '../page-metadata-defaults';

	let props: import('./page-metadata.svelte').PageMetadataProps = $props();
